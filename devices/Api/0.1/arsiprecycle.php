...
$NEWTOKEN="eyJkaXIiOiJkZXZpY2VzXC9BcGlcLzAuMVwvYXJzaXByZWN5Y2xlLnBocCIsInVpZCI6MX0";
if($_SERVER["REQUEST_METHOD"] === "POST") {
$val=json_decode(file_get_contents("php://input"));
$db=new tatiye();
$tabel="appsampah";
$keywords="arsip,id";
//$chart=tatiye::chart("appsampah","index");
//$chartMonth=tatiye::chartMonth("appsampah","index",$chart);
$COUNT=tatiye::fetch("appsampah"," COUNT(*) as count");
