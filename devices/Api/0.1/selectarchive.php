...
$NEWTOKEN="eyJkaXIiOiJkZXZpY2VzXC9BcGlcLzAuMVwvc2VsZWN0YXJjaGl2ZS5waHAiLCJ1aWQiOjF9";
if($_SERVER["REQUEST_METHOD"] === "POST") {
$val=json_decode(file_get_contents("php://input"));
$db=new tatiye();
$tabel="apparchive";
$keywords="nama,package,categori,deskripsi,keyid,nmtabel,arsip,bookmark";
