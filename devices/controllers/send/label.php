<?php                                                                                      
  ...
  #| @Date  Jumat 27 Oktober 2023, 09:26:50 PM                                        
  if($segmen == "insert") {                                                           
  ...
  if (empty($val["error"])) {    
    ...
    if ($_POST["a6"]=='office') {
        $keyid=tatiye::fetch("appoffice","*","id='".$_POST["a4"]."'"); 
        $fileType=$keyid['fileType'];                                                    
        $newToken=$keyid['newToken'];    
    } else if ($_POST["a6"]=='sisinfo') {
        $keyid=tatiye::fetch("sisinfo","*","id='".$_POST["a4"]."'"); 
        $fileType='xlsx';                                                    
        $newToken=$keyid['id'];                                           
    } else {
        $fileType='';                                                    
