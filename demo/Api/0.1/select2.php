...
$NEWTOKEN="eyJkaXIiOiJkZW1vXC9BcGlcLzAuMVwvc2VsZWN0Mi5waHAiLCJ1aWQiOjF9";
if($_SERVER["REQUEST_METHOD"] === "POST") {
$val=json_decode(file_get_contents("php://input"));
$db=new tatiye();
$tabel="demo";
$keywords="nama,title,Provinsi,Kabupaten,Kecamatan,deskripsi,Desa,kode,id";
...
$QUERY="SELECT 
        nama,title,Provinsi,Kabupaten,Kecamatan,deskripsi,Desa,kode,id 
        FROM demo
