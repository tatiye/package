...
$NEWTOKEN="eyJkaXIiOiJkYXRhdGFibGVzXC9BcGlcLzAuMVwvaW5zZXJ0Mi5waHAiLCJ1aWQiOjF9";
...
if($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  #| @Date  Rabu 27 September 2023, 10:43:27 PM                                 
  if($segmen == "insert") {                                                     
  $val=tatiye::validation([                                                     
     "Provinsi"=>tatiye::val("text",$_POST["Provinsi"]   ,"2|Wajib diisi"),     
     "Kabupaten"=>tatiye::val("text",$_POST["Kabupaten"]   ,"2|Wajib diisi"),   
  ]);                                                                           
  if (empty($val["error"])) {                                                   
     $data = array(                                                             
