...
$NEWTOKEN="eyJkaXIiOiJiaWxpbmdcL0FwaVwvMC4xXC9iaWxpbmcucGhwIiwidWlkIjoxfQ";
if($_SERVER["REQUEST_METHOD"] === "POST") {
$val=json_decode(file_get_contents("php://input"));
$db=new tatiye();
$tabel="biling";
$keywords="idsales,categori,nama,harga,jumlah";
//$chart=tatiye::chart("biling","index");
//$chartMonth=tatiye::chartMonth("biling","index",$chart);
...
$QUERY="SELECT 
        idsales,categori,nama,harga,jumlah
        FROM biling
