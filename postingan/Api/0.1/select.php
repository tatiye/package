...
use app\models\storage;
 $Text=tatiye::Text();
$NEWTOKEN="eyJkaXIiOiJwb3N0aW5nYW5cL0FwaVwvMC4xXC9zZWxlY3QucGhwIiwidWlkIjoxfQ";
if($_SERVER["REQUEST_METHOD"] === "POST") {
$val=json_decode(file_get_contents("php://input"));
$db=new tatiye();
$tabel="appnews";
$keywords="title,description,id";
...
$QUERY="SELECT 
        *
        FROM appnews
        WHERE segment='Tatiye' $search ORDER BY ascId  ".$data["record"];
