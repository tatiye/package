...
$NEWTOKEN="eyJkaXIiOiJwb3N0aW5nYW5cL0FwaVwvMC4xXC9hcGlOZXdzLnBocCIsInVpZCI6MX0";
  Authorization::init(1);
if($_SERVER["REQUEST_METHOD"] === "GET") {
$QUERY="SELECT 
        *
        FROM appnews
        WHERE categori='Public'   ORDER BY id DESC  ";
$COUNT=tatiye::fetch("appnews"," COUNT(*) as count","categori='Public'");
  $number=0;                                                            
