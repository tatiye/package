...
$NEWTOKEN="eyJkaXIiOiJwcm9maWxcL0FwaVwvMC4xXC9waG90by5waHAiLCJ1aWQiOjF9";
...
// DIREKTORY FILE
if (!file_exists(tatiye::dir()."/public/images/".tatiye::dt("Y")."/".tatiye::dt("M")."/".$id)) {
  @mkdir(tatiye::dir()."/public/images/".tatiye::dt("Y"), 0700);
  @mkdir(tatiye::dir()."/public/images/".tatiye::dt("Y")."/".tatiye::dt("M"), 0700);
  @mkdir(tatiye::dir()."/public/images/".tatiye::dt("Y")."/".tatiye::dt("M")."/".$id, 0700);
}
$target_dir = tatiye::dir()."/public/images/".tatiye::dt("Y")."/".tatiye::dt("M")."/".$id."/";
